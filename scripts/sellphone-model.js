import { showModelDetails, mobileCheckStep2, mobileCheckStep3, updateCurrentStep, showNextButton, hideNextButton,showFinalPrice } from "./mobilecheck.js";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener("popstate", function () {
        ...
        if (currentStep === 4) {
            ...
            window.location.href = "sell_phone.html"; // Redirect to brands page
        }
    });
    ...
    if (backButton) {
        backButton.addEventListener("click", function () {
            ...
            if (selectedBrand && !selectedModel) {
                window.location.href = "sell_phone.html"; // Go back to sell_phone.html
            }
